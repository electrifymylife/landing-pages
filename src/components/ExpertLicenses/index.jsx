...
import * as style from './expertLicenses.module.scss';
import { CarouselFullscreen } from '../CarouselFullscreen';
import expertLicenses from "./data/expertLicenses.json";
export const ExpertLicenses = ({ data=expertLicenses, subTitleColor, navColor }) => {
  ...
  React.useEffect(() => {
    if (swiperEl.current) {
      Object.assign(swiperEl.current, {
        ...
        spaceBetween: 5,
        pagination: {
          el: '.expert-licenses__pagination',
          clickable: true,
        },
  ...
  return (
    <>
      <div className={style.expertLicenses}>
        ...
        <div
          className={`${style.pagination} expert-licenses__pagination`}
          style={{
